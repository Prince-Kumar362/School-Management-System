...
class StudentRegiststrationFeeController extends Controller
{
    /**
    ...
    public function index() 
    {
        ...
        return view('backend.Student.Registration_fee.index',compact('years','classes'));
    }
    ...
    public function payslip(Request $request){
        ...
        return view('backend.Student.Registration_fee.print',compact('data'));
    }
}
