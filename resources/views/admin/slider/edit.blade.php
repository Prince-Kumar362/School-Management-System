                    ...
                    <div class="col-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                        <form novalidate action="{{ url('Slider/update/' . $image->id) }} " method="POST" autocomplete="off" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="description"  class="form-control"  placeholder="Enter Description">{{ $image->description }}</textarea>
