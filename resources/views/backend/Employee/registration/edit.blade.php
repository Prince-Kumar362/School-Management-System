        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" action="{{ route('employee.registration.edit',$data->id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="father_name" class="form-control" required="" value="{{ $data->father_name }}">
                                                    </div>
                                                </div>
                                            </div> <!-- End Col md 4 -->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="mother_name" class="form-control" required="" value="{{ $data->mother_name }}">
                                                    </div>
                                                </div>
                                            </div> <!-- End Col md 4 -->
                                        </div> <!-- End 1stRow -->
                                                    ...
                                                    <div class="controls">
                                                        <select name="religion" id="religion" required="" class="form-control">
                                                            ...
                                                            <option value="Hindu" {{ ($data->religion == 'Hindu')? 'selected': '' }}>
                                                                Hindu</option>
                                                            <option value="Christan" {{ ($data->religion == 'Christan')? 'selected': '' }}>
                                                                Christan</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="designation_id" required="" class="form-control">
                                                            ...
                                                            <option value="{{ $desi->id }}" {{ ($data->designation_id == $desi->id)?'selected':'' }}>
                                                                {{ $desi->name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="salary" class="form-control" required="" value="{{ $data->salary }}">
                                                    </div>
                                                </div>
                                            </div> <!-- End Col md 3 -->
                                            @endif
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <img id="showImage" src="{{ (!empty($data->image))? url('upload/employee_images/'.$data->image):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;">
                                                    </div>
                                                </div>
                                            </div> <!-- End Col md 3 -->
                                        </div> <!-- End 4TH Row -->
