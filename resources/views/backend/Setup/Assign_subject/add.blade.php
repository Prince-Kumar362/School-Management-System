                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">Fee Assign Subject</li>
                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Assign Subject Add</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form novalidate action="{{ route('assign.subject.add') }} " method="POST"
                                            autocomplete="off">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12">
