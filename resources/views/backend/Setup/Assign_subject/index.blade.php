                                        ...
                                        <tbody>
                                            @foreach ($datas as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('assign.subject.edit',$data->class_id)}}" class="btn btn-rounded btn-info">Edit</a>
                                                        <a href="{{route('assign.subject.show',$data->class_id)}}" class="btn btn-rounded btn-primary">Details</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
