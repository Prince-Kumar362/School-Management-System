                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Fee Amount Edit</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form novalidate action="{{route('fee.amount.update',$data[0]->fee_category_id)}}" method="POST"
                                            autocomplete="off">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                            ...
                                                            <select name="fee_category_id" required class="form-control">
                                                                ...
                                                                @foreach ($fee_categorys as $fee_category)
                                                                    <option value="{{ $fee_category->id }}"
                                                                        {{ $data[0]->fee_category_id == $fee_category->id ? 'selected' : '' }}>
