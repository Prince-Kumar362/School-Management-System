                                        ...
                                        <tbody>
                                            @foreach ($datas as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('fee.amount.edit',$data->fee_category_id)}}" class="btn btn-rounded btn-info">Edit</a>
                                                        <a href="{{route('fee.amount.show',$data->fee_category_id)}}" class="btn btn-rounded btn-primary">Details</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
