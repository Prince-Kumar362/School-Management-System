                                        ...
                                        <tbody>
                                            @foreach ($datas as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data->name }}</td>
                                                    <td>
                                                        <a href="{{route('school.subject.edit',$data->id)}}" class="btn btn-rounded btn-info">Edit</a>
                                                        <a href="{{route('school.subject.delete',$data->id)}}" id="delete" class="btn btn-rounded btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
