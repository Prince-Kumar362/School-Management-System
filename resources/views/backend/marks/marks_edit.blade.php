            ...
            <div class="row">
                <div class="col-12">
                    <div class="box bb-3 border-warning">
                        ...
                        <div class="box-body">
                            <form method="post" action="{{ route('marks.marks.update') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, v) {
                    html +=
                        '<tr>' +
                        '<td>' + v.student.id_number + '<input type="hidden" name="student_id[]" value="' + v.student_id + '"> <input type="hidden" name="id_no[]" value="' + v.student.id_number + '"> </td>' +
...
<script type="text/javascript">
    $(function() {
        $(document).on('change', '#class_id', function() {
            var class_id = $('#class_id').val();
            $.ajax({
                url: "{{ route('student.edit.getsubject') }}",
                type: "GET",
                data: {
                    class_id: class_id
                },
